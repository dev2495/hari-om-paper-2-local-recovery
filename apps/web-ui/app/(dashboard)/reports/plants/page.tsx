...
export default function PlantsReportsPage() {
  ...
  const { data, isLoading, isError, refetch } = usePlantCompareReport({ startDate, endDate, plant, granularity })
  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? <LoadingState label="Loading plant comparison…" /> : null}
      {isError ? (
        <ErrorState
          message="Plant comparison could not be loaded. Refresh to retry."
          onRetry={() => {
            void refetch()
          }}
        />
