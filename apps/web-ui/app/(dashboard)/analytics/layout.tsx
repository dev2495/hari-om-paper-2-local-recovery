        ...
        <div className="flex flex-wrap items-end gap-3">
          <div className="space-y-1">
            ...
            <input
              ...
              className="h-10 rounded-xl border border-border bg-card px-3 text-sm font-medium text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            />
          </div>
          <div className="space-y-1">
