...
COMPAT_DYNAMIC_FIELDS: dict[str, dict[str, str]] = {
    ...
    "notching_holder": {"label": "Notching Holder", "field_type": "text"},
    "notching_blade": {"label": "Notching Blade", "field_type": "text"},
    "groove": {"label": "Groove", "field_type": "text"},
    "punch": {"label": "Punch", "field_type": "text"},
    "tochha": {"label": "Tochha", "field_type": "text"},
    "tochha_type": {"label": "Tochha Type", "field_type": "text"},
    "wider_tool": {"label": "Wider Tool", "field_type": "text"},
    "height_gauge_go": {"label": "Height Gauge Go", "field_type": "text"},
    "height_gauge_no_go": {"label": "Height Gauge No Go", "field_type": "text"},
    "die": {"label": "Die", "field_type": "text"},
