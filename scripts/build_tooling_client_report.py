...
def build():
    ...
    story += [P("Deployment status", "H2Custom"), P("Release commit 8740c55 is committed and pushed to GitHub. The linked Railway service remains online on its previous deployment. Railway refused the new upload because the account trial has expired; after selecting a Railway plan, redeploy this commit and run the authenticated production smoke test.", "Callout")]
    story += [table([["Verification", "Result"], ["Service compilation", "Passed"], ["Master tooling contract", "3 passed"], ["Physical lifecycle tests", "2 passed"], ["Web unit/static checks", "Passed"], ["TypeScript and production build", "Passed"], ["Dependency audit", "0 vulnerabilities"], ["Focused browser tooling/spec suite", "2 passed"], ["BFF health and service startup", "Healthy / ready"]], [70 * mm, 104 * mm])]
