...
- Served origin: `http://127.0.0.1:23000` BUILD_ID `EYFrs5GhOyHNGtioE2__r` (QCT-062 required instrument evidence). Prior `_opGJjeYOkhKoqBiWqi2C` QCT-060 missing-setup + QCT-061 attach.
- Focused QCT-062: **1 passed / 0 failed** in 4.9s — `output/playwright/EYFrs5GhOyHNGtioE2__r-qct062/`
- Uncontended full Chromium on this BUILD_ID: **48 passed / 0 failed** in 2.5m — `output/playwright/EYFrs5GhOyHNGtioE2__r-full/`. Auth `:28001` pid **9821** stayed up. One uninterrupted 48/48. QCT-062 passed as test 31. Do not overlay-PASS those release-gate tests as original COMM/REL IDs.
...
- Includes BJ01–BJ12 surfaces plus `e2e/original-partials.spec.cjs` (QC-01, COMM-08, INC-02, QCT-029–062)
