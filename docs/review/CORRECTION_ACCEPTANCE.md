...
- [ ] Live overlapping Postgres proof (RR03, RR13)
- [ ] Playwright / browser UAT against a running stack
- [ ] Docker artifact boot with packaged `shared/hariom_quality_eval.py`
