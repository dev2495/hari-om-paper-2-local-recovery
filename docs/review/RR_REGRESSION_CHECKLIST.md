...
Local candidate: QCT-031 incomplete-draft save; served UI BUILD_ID `yO-4tO8AIjEk88hPrVkEW`; parent `f406968`; docs start `151889b`  
...
| RR32 | Spec QC dialog keeps product context, dialog role, Escape | PASS | BJ11 keyboard/Escape on Add Tool; QCT-029 Chromium Save Draft dialog shows product/helper context; QCT-030 Back/discard; QCT-031 incomplete draft. |
...
Definitions restored under `docs/review/baseline-v2/`. Overlay: PASS 66, PARTIAL 21, LIMITATION 3, NOT_RUN 102. Additive RR tests above do not replace the pack. See `docs/review/V2_PACK_PROVENANCE.md` and `docs/review/ACCEPTANCE_OVERLAY.json`.
