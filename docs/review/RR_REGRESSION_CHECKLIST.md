...
Local candidate: `df3a0ca` QCT-046/047; served UI BUILD_ID `Y6UYiRh5YVC2OXjR_TPZF`; parent `a24b843`  
...
| RR32 | Spec QC dialog keeps product context, dialog role, Escape | PASS | BJ11 keyboard/Escape on Add Tool; QCT-029 Chromium Save Draft dialog shows product/helper context; QCT-030 Back/discard; QCT-031 incomplete draft; QCT-033 double-click; QCT-035 list Add quality parameters; QCT-037 assign-profile drafts; QCT-040 three-stage client names; QCT-041 NOT APPLICABLE; QCT-042 stage basis; QCT-043/044 frozen rev A print; QCT-045 FAIL text/limit/difference; QCT-046/047 multi-page paired-oven and historical freeze print. |
| RR33 | Job-card print/actuals: samples in quality_checks; kg separate from g | PASS | BJ12 plus QCT-046 three-page writable paired-oven print and QCT-047 signed freeze |
...
Definitions restored under `docs/review/baseline-v2/`. Overlay: PASS 81, PARTIAL 21, LIMITATION 3, NOT_RUN 87. Additive RR tests above do not replace the pack. See `docs/review/V2_PACK_PROVENANCE.md` and `docs/review/ACCEPTANCE_OVERLAY.json`.
