...
Local candidate: `bb0af79` QCT-033/034/035/036; served UI BUILD_ID `k27eP26jMMBcNXZRNOfEk`; parent `94e4af6`  
...
| RR32 | Spec QC dialog keeps product context, dialog role, Escape | PASS | BJ11 keyboard/Escape on Add Tool; QCT-029 Chromium Save Draft dialog shows product/helper context; QCT-030 Back/discard; QCT-031 incomplete draft; QCT-033 double-click; QCT-035 list Add quality parameters. |
...
Definitions restored under `docs/review/baseline-v2/`. Overlay: PASS 70, PARTIAL 21, LIMITATION 3, NOT_RUN 98. Additive RR tests above do not replace the pack. See `docs/review/V2_PACK_PROVENANCE.md` and `docs/review/ACCEPTANCE_OVERLAY.json`.
