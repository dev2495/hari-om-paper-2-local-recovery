...
Local candidate: `a24b843` QCT-045; served UI BUILD_ID `HpyC8zTCwPorWtmZba6jZ`; parent `76ca2ba`  
...
Definitions restored under `docs/review/baseline-v2/`. Overlay: PASS 79, PARTIAL 21, LIMITATION 3, NOT_RUN 89. Additive RR tests above do not replace the pack. See `docs/review/V2_PACK_PROVENANCE.md` and `docs/review/ACCEPTANCE_OVERLAY.json`.
