...
Local candidate: `72262de` QCT-050; served UI BUILD_ID `RuDVwRuPutn9QGHEBn6so`; parent `8db296c`  
...
Definitions restored under `docs/review/baseline-v2/`. Overlay: PASS 84, PARTIAL 21, LIMITATION 3, NOT_RUN 84. Additive RR tests above do not replace the pack. See `docs/review/V2_PACK_PROVENANCE.md` and `docs/review/ACCEPTANCE_OVERLAY.json`.
