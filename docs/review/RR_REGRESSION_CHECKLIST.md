...
Local candidate: `096ca77` QCT-040/041/042; served UI BUILD_ID `kgewJhcCUr2soAFKW5p8A`; parent `cb30e30`  
...
Definitions restored under `docs/review/baseline-v2/`. Overlay: PASS 76, PARTIAL 21, LIMITATION 3, NOT_RUN 92. Additive RR tests above do not replace the pack. See `docs/review/V2_PACK_PROVENANCE.md` and `docs/review/ACCEPTANCE_OVERLAY.json`.
