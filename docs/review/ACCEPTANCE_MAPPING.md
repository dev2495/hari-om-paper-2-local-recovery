...
**Local product HEAD this cycle:** `1943b30` QCT-062 required instrument evidence on parents overlay `0edff86` / product `279dfc0`. Served BUILD_ID `EYFrs5GhOyHNGtioE2__r`.  
**Chromium candidate:** BUILD_ID `EYFrs5GhOyHNGtioE2__r` on `:23000` — focused QCT-062 **1/1** in 4.9s; uncontended full Chromium **48 passed / 0 failed** in 2.5m (auth `:28001` stayed up). One uninterrupted 48/48. Not original COMM/REL pack PASS.  
...
`DEM-01`, `DEM-03`–`DEM-05`, `DEM-07`–`DEM-08`, `NAV-02`, `INC-01`, `REG-02`, `QCT-004`, `QCT-012`, `QCT-063`–`QCT-106`, `QCT-108`–`QCT-122`, `QCT-124`–`QCT-126`
...
See `docs/review/BROWSER_JOURNEYS.md`. Focused QCT-062 **1/1** on BUILD_ID `EYFrs5GhOyHNGtioE2__r`. Full Chromium **48 passed / 0 failed** in 2.5m (auth stayed up). WebKit BLOCKED. Safari.app BLOCKED. BJ13 human UAT **NOT_RUN**.
