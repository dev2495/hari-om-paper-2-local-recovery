...
**Local product HEAD this cycle:** `cb30e30` QCT-037 assign-profile drafts and QCT-038/039 canonical finals (served BUILD_ID `vXkaPC37ZEz_eM-c37Pxr`; parent `bb0af79` QCT-033/035).  
**Chromium candidate:** BUILD_ID `vXkaPC37ZEz_eM-c37Pxr` on `:23000` — Chromium project **28/28 PASS** (`--workers=1`, 1.5m, `PLAYWRIGHT_CHROME_CHANNEL=chrome`). Prior `k27eP26jMMBcNXZRNOfEk` 27/27 does not bind this bundle.  
...
| Requirements overlay `PASS` | `R12`, `R13`, `R14`, `R15`, `R19`, `QCR-03`, `QCR-04`, `QCR-06`, `QCR-08`, `QCR-09` |
...
`DEM-01`, `DEM-03`–`DEM-05`, `DEM-07`–`DEM-08`, `NAV-02`, `INC-01`, `REG-02`, `QCT-004`, `QCT-012`, `QCT-040`–`QCT-051`, `QCT-053`–`QCT-106`, `QCT-108`–`QCT-122`, `QCT-124`–`QCT-126`
...
| RR32–RR33 | PASS | Chromium BJ11/BJ12 on BUILD_ID `vXkaPC37ZEz_eM-c37Pxr`; QCT-029/030/031/033/035/037 Save Draft / list Add quality parameters / assign-profile also proven |
...
See `docs/review/BROWSER_JOURNEYS.md`. BJ01–BJ12 Chromium **re-run PASS** on BUILD_ID `vXkaPC37ZEz_eM-c37Pxr` (original-partials QC-01/COMM-08/INC-02/QCT-029/QCT-030/QCT-031/QCT-033/QCT-035/QCT-037 PASS). Theme Chromium light+dark 6 PASS historically. PLAN-09 keyboard/narrow Chromium 1 PASS. WebKit BLOCKED. Safari.app BLOCKED. BJ13 human UAT **NOT_RUN**.
