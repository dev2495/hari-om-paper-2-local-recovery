...
**Local product HEAD this cycle:** `7fba655ad3208e4995abfd90b41f9a457a24c984` after docs `151889b` / overlay `379ac8a` / product `34e116d` (parchment conflict UI, QC landing, reject-remainder, QC task retry, books-lock GRN, group-move, bulk release).  
**Chromium candidate:** BUILD_ID `RK019_Yv2Kl45fbmQXLHA` on `:23000` (BJ01–BJ12 re-run on this BUILD_ID). Prior harness `5dd8b9b` is historical.  
...
`DEM-01`, `DEM-03`–`DEM-05`, `DEM-07`–`DEM-08`, `NAV-02`, `INC-01`, `REG-02`, `QCT-004`, `QCT-012`, `QCT-030`–`QCT-051`, `QCT-053`–`QCT-106`, `QCT-108`–`QCT-122`, `QCT-124`–`QCT-126`
...
| RR32–RR33 | PASS | Chromium BJ11/BJ12 on BUILD_ID `RK019_Yv2Kl45fbmQXLHA`; QCT-029 Save Draft dialog product context also proven |
...
See `docs/review/BROWSER_JOURNEYS.md`. BJ01–BJ12 Chromium **re-run PASS** on BUILD_ID `RK019_Yv2Kl45fbmQXLHA` (tooling physical-tools restored on compact supervisor layout; original-partials QC-01/COMM-08/INC-02/QCT-029 PASS). Theme Chromium light+dark 6 PASS. PLAN-09 keyboard/narrow Chromium 1 PASS. WebKit BLOCKED. Safari.app BLOCKED. BJ13 human UAT **NOT_RUN**.
