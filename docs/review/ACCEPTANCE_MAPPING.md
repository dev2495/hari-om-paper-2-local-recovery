...
**Local product HEAD this cycle:** `bb0af79` QCT-033 save-key replay/conflict and QCT-035 list Add quality parameters (served BUILD_ID `k27eP26jMMBcNXZRNOfEk`; parent `94e4af6` QCT-032).  
**Chromium candidate:** BUILD_ID `k27eP26jMMBcNXZRNOfEk` on `:23000` — Chromium project **27/27 PASS** (`--workers=1`, 1.5m, `PLAYWRIGHT_CHROME_CHANNEL=chrome`). Prior `yO-4tO8AIjEk88hPrVkEW` 25/25 does not bind this bundle.  
...
Chromium project 27/27 on BUILD_ID `k27eP26jMMBcNXZRNOfEk` includes BJ01–BJ12 plus original-partials; that is not the 192-case pack.
...
`DEM-01`, `DEM-03`–`DEM-05`, `DEM-07`–`DEM-08`, `NAV-02`, `INC-01`, `REG-02`, `QCT-004`, `QCT-012`, `QCT-037`–`QCT-051`, `QCT-053`–`QCT-106`, `QCT-108`–`QCT-122`, `QCT-124`–`QCT-126`
...
| RR32–RR33 | PASS | Chromium BJ11/BJ12 on BUILD_ID `k27eP26jMMBcNXZRNOfEk`; QCT-029/030/031/033/035 Save Draft / list Add quality parameters also proven |
...
See `docs/review/BROWSER_JOURNEYS.md`. BJ01–BJ12 Chromium **re-run PASS** on BUILD_ID `k27eP26jMMBcNXZRNOfEk` (original-partials QC-01/COMM-08/INC-02/QCT-029/QCT-030/QCT-031/QCT-033/QCT-035 PASS). Theme Chromium light+dark 6 PASS historically. PLAN-09 keyboard/narrow Chromium 1 PASS. WebKit BLOCKED. Safari.app BLOCKED. BJ13 human UAT **NOT_RUN**.
