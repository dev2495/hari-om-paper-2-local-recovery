...
**Local product HEAD this cycle:** `df3a0caaa471f292948963faa30bd5619c6ba01c` QCT-046/047 print freeze (served BUILD_ID `Y6UYiRh5YVC2OXjR_TPZF`; parent `a24b843` QCT-045; `76ca2ba` QCT-043/044).  
**Chromium candidate:** BUILD_ID `Y6UYiRh5YVC2OXjR_TPZF` on `:23000` — Chromium project **35/35 PASS** (`--workers=1`, 1.7m, `PLAYWRIGHT_CHROME_CHANNEL=chrome`). Prior `HpyC8zTCwPorWtmZba6jZ` 33/33 does not bind this bundle.  
...
`DEM-01`, `DEM-03`–`DEM-05`, `DEM-07`–`DEM-08`, `NAV-02`, `INC-01`, `REG-02`, `QCT-004`, `QCT-012`, `QCT-048`–`QCT-051`, `QCT-053`–`QCT-106`, `QCT-108`–`QCT-122`, `QCT-124`–`QCT-126`
...
| RR32–RR33 | PASS | Chromium BJ11/BJ12 on BUILD_ID `Y6UYiRh5YVC2OXjR_TPZF`; QCT-029–047 Save Draft / stage templates / NOT APPLICABLE / stage basis / rev A print freeze / FAIL text / multi-page paired-oven print also proven |
...
See `docs/review/BROWSER_JOURNEYS.md`. BJ01–BJ12 Chromium **re-run PASS** on BUILD_ID `Y6UYiRh5YVC2OXjR_TPZF` (original-partials QC-01/COMM-08/INC-02/QCT-029–047 PASS). Theme Chromium light+dark 6 PASS historically. PLAN-09 keyboard/narrow Chromium 1 PASS. WebKit BLOCKED. Safari.app BLOCKED. BJ13 human UAT **NOT_RUN**.
