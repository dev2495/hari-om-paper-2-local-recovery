...
**Local product HEAD this cycle:** QCT-031 incomplete-draft save on the spec QC dialog (served BUILD_ID `yO-4tO8AIjEk88hPrVkEW`; parent `f406968` QCT-030).  
**Chromium candidate:** BUILD_ID `yO-4tO8AIjEk88hPrVkEW` on `:23000` — Chromium project **25/25 PASS** (`--workers=1`, 1.5m). Prior `5dd8b9b` 15/15, `RK019_Yv2Kl45fbmQXLHA`, and `NvnOVx0kmQ03d9QgGA7fW` 24/24 do not bind this bundle.  
...
Chromium project 25/25 on BUILD_ID `yO-4tO8AIjEk88hPrVkEW` includes BJ01–BJ12 plus original-partials; that is not the 192-case pack.
...
| RR32–RR33 | PASS | Chromium BJ11/BJ12 on BUILD_ID `yO-4tO8AIjEk88hPrVkEW`; QCT-029/030/031 Save Draft dialog also proven |
...
See `docs/review/BROWSER_JOURNEYS.md`. BJ01–BJ12 Chromium **re-run PASS** on BUILD_ID `yO-4tO8AIjEk88hPrVkEW` (original-partials QC-01/COMM-08/INC-02/QCT-029/QCT-030/QCT-031 PASS). Theme Chromium light+dark 6 PASS. PLAN-09 keyboard/narrow Chromium 1 PASS. WebKit BLOCKED. Safari.app BLOCKED. BJ13 human UAT **NOT_RUN**.
