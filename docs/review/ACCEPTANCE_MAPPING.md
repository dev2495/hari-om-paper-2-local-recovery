...
**Local product HEAD this cycle:** `338ebedf9dcbd836fc59719cc8d3db93eb237693` plus QCT-030 preserve/discard on the spec QC dialog (served BUILD_ID `NvnOVx0kmQ03d9QgGA7fW`).  
**Chromium candidate:** BUILD_ID `NvnOVx0kmQ03d9QgGA7fW` on `:23000` — Chromium project **24/24 PASS** (`--workers=1`, 1.4m). Prior `5dd8b9b` 15/15 and `RK019_Yv2Kl45fbmQXLHA` do not bind this bundle.  
...
`DEM-01`, `DEM-03`–`DEM-05`, `DEM-07`–`DEM-08`, `NAV-02`, `INC-01`, `REG-02`, `QCT-004`, `QCT-012`, `QCT-031`–`QCT-051`, `QCT-053`–`QCT-106`, `QCT-108`–`QCT-122`, `QCT-124`–`QCT-126`
...
| RR32–RR33 | PASS | Chromium BJ11/BJ12 on BUILD_ID `NvnOVx0kmQ03d9QgGA7fW`; QCT-029 Save Draft dialog product context also proven |
...
See `docs/review/BROWSER_JOURNEYS.md`. BJ01–BJ12 Chromium **re-run PASS** on BUILD_ID `NvnOVx0kmQ03d9QgGA7fW` (tooling physical-tools restored on compact supervisor layout; original-partials QC-01/COMM-08/INC-02/QCT-029/QCT-030 PASS). Theme Chromium light+dark 6 PASS. PLAN-09 keyboard/narrow Chromium 1 PASS. WebKit BLOCKED. Safari.app BLOCKED. BJ13 human UAT **NOT_RUN**.
