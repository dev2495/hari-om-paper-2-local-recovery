...
- Local HEAD before this QCT-031 product commit: `f406968223ef2f1741ea34bc5b76525139c43dea` (QCT-030 overlay PASS 64). Product ancestry `7fba655` after docs `151889b` / overlay `379ac8a` / product `34e116d` / Escape `338ebed`. No force-push, no discarded work.
- Chromium **25/25 PASS** on served BUILD_ID `yO-4tO8AIjEk88hPrVkEW` (`--project=chromium --workers=1`, 1.5m). Includes BJ01–BJ12 plus original-partials QC-01/COMM-08/INC-02/QCT-029/QCT-030/QCT-031. Prior `5dd8b9b` 15/15, `RK019_Yv2Kl45fbmQXLHA`, and `NvnOVx0kmQ03d9QgGA7fW` 24/24 do **not** stand for this bundle.
...
- Isolated pids this wave: Next **8078** :23000 (launcher 8042), BFF **2340** :24000, production **2334** :28004, inventory **2331** :28005, sales **2337** :28008, auth **90290** :28001, master **90295** :28002, spec **7788** :28003, analytics **13483** :28007. Foreign 13000 left running. Spec and Next were restarted after QCT-031 source change; earlier 143 exits were restart SIGTERMs of the isolated nverify listeners only.
