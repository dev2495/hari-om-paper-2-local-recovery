...
- Isolated pids this wave: Next **90619** :23000, BFF **75339** :24000, production **94008** :28004 (venv-verify, MASTERDATA_SERVICE_URL `http://127.0.0.1:28002`), inventory **2331** :28005, sales **2337** :28008, auth **89325** :28001, master **90295** :28002, spec **31405** :28003, analytics **13483** :28007. Foreign 13000 pid 69663 left running.
...
- Chromium: **1 passed / 0 failed** in 5.2s on BUILD_ID `Jsi64h520Xs_8mFfUP9Qr` after books-state catalog fetch no longer 500s on unresolved master hostname. First Chromium fail was Stage QC job-cards unload (production down / JWT). Second listed FAIL was `assertCritical` on `/api/production/books-state` 500 while original QCT-056 asserts had already passed.
